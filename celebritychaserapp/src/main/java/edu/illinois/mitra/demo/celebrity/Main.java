package edu.illinois.mitra.demo.celebrity;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        settings.WAYPOINT_FILE("celebritychaserapp/waypoints/tag.wpt");
        settings.INITIAL_POSITIONS_FILE("celebritychaserapp/waypoints/start.wpt");
        settings.DRAW_TRACE_LENGTH(-1);
        settings.DRAW_WAYPOINTS(false);
        settings.DRAW_WAYPOINT_NAMES(false);
        settings.DRAWER(new CelebrityDrawer());
